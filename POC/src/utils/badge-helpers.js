/**
 * Badge helper utilities for opportunity intent (OFFER/NEED) styling per module.
...
/**
 * Returns the CSS class name for the intent badge (OFFER/NEED) based on intent and modelType.
