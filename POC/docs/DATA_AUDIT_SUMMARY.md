...
- **Users**: 0 with missing fields
- **Companies**: 0 with missing fields

## 4. Orphan records

- **applications**: 0 orphan(s)
- **matches**: 0 orphan(s)
- **notifications**: 0 orphan(s)
...
- **subscription_plans**: No seed file
- **subscriptions**: No seed file
